...
- **Migration status:** Chat page, sidebar, library, study, and all admin pages fully on design tokens. Remaining old hex: `components/center/DocumentCard.tsx`, `app/admin/edit/[id]/page.tsx` editor panel, `app/library/page.tsx`, `app/library/authors/page.tsx`, `app/library/book/[id]/page.tsx`, `app/document/[id]/page.tsx`. Re-migration pending.
...
- ~~**Phase 4 hex→token migration reverted by linter**~~ — **PARTIALLY DONE (June 2026):** `app/rhemata-corpus-admin/` deleted (files gone). `app/admin/page.tsx` rewritten with design tokens. Remaining old hex: `components/center/DocumentCard.tsx`, `app/admin/edit/[id]/page.tsx` editor panel, `app/library/page.tsx`, `app/library/authors/page.tsx`, `app/library/book/[id]/page.tsx`, `app/document/[id]/page.tsx`. Re-migration pending.
