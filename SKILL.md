...
- **Migration status:** Chat page, sidebar, library (Discover), study, and all admin pages fully on design tokens. Remaining old hex: `components/center/DocumentCard.tsx`, `app/admin/edit/[id]/page.tsx` editor panel, `app/library/authors/page.tsx`, `app/library/book/[id]/page.tsx`, `app/document/[id]/page.tsx`. Re-migration pending.
