...
Generated: 2026-08-08 21:23:49 UTC
...
4. Re-embedded each unique question and each unique quote topic with the production
...
6. Applied the same top-`MAX_QUOTES_PER_ANSWER` cap the selector uses.
...
vs. **rejected** (candidate pairs that scored below 0.40 or were pushed out by the
top-3 cap).
...
- **Questions with any quote**: distinct answered questions receiving at least one quote.
- **New pairs vs 0.40**: pairs that qualify at this threshold but not at 0.40.
- **New questions vs 0.40**: questions that would receive a quote for the first time
  at this threshold (i.e., they received none at 0.40 but would receive at least one here).

| Threshold | Selected pairs | Questions with any quote | New pairs vs 0.40 | New questions vs 0.40 |
| --- | --- | --- | --- | --- |
| 0.40 | 12 | 3 | 0 | 0 |
| 0.35 | 12 | 3 | 0 | 0 |
| 0.30 | 12 | 3 | 0 | 0 |
...
first impression for human review, not a rule-based label.
...
| Score | Question | Topic | Teacher | Served at 0.40? |
| --- | --- | --- | --- | --- |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
...
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.7451 | What does it mean to wait on God? | waiting on God | Andrew Murray | yes |
| 0.5790 | What did Andrew Murray teach about waiting on God? | waiting on God | Andrew Murray | no |
| 0.4587 | Why did Jesus fast in the wilderness? | fasting | Derek Prince | yes |
| 0.2786 | Why did Jesus fast in the wilderness? | waiting on God | Andrew Murray | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
...
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1958 | What does it mean to wait on God? | fasting | Derek Prince | no |
| 0.1920 | What is the baptism of the Holy Spirit? | fasting | Derek Prince | no |
| 0.1760 | What did Andrew Murray teach about waiting on God? | fasting | Derek Prince | no |
| 0.0612 | What are the five-fold ministry gifts in Ephesians 4? | fasting | Derek Prince | no |
| 0.0612 | What are the five-fold ministry gifts in Ephesians 4? | fasting | Derek Prince | no |
| 0.0171 | What does the Bible teach about the gifts of the Holy Spirit, and how are bel... | fasting | Derek Prince | no |
