...
7. **SP2 Phases 5–10** — not started. Phase 2 (attribution) DONE (commits `1000bef`, `d4e1423`); Phase 3 (SP1 verified-verse swap) DONE (commit `da37bba`), MID-POINT STOP reached; Phase 4 (fix "your teachers on this verse") DONE (commits `af5be46`, `8698e4a`). Phase 5 (pin system rebuild) is next in sequence per the committed plan.
