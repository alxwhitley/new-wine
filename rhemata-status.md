...
Last verified: 2026-07-23 (Chat-only beta: gate Study/Discover, Phases 0-5 — see directly below).
Records reconciled: 2026-07-22 (Study Panel refinement v2 + pin-dropdown bug — see the section below the new one).
