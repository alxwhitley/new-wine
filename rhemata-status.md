...
7. **SP2 Phases 6–10** — not started. Phase 2 (attribution) DONE (commits `1000bef`, `d4e1423`); Phase 3 (SP1 verified-verse swap) DONE (commit `da37bba`), MID-POINT STOP reached; Phase 4 (fix "your teachers on this verse") DONE (commits `af5be46`, `8698e4a`); Phase 5 (pin system rebuild) DONE (commits `8ec1f5d`, `f4576f4`, `9e17c7f`, `cd2cf7b`, `8e2d4e3`, `8ac2f12`, `7357bad`). Phase 6 (shared-component extraction) is next in sequence per the committed plan.
