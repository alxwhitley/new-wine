...
Last verified: 2026-07-23 (fix commit `0e2f32c` for the textarea-focus-blocks-panel bug, see the Open Blockers list in the Study Panel geometry v3 entry directly below — both listed blockers are now closed).
Records reconciled: 2026-07-23 (Chat-only beta: gate Study/Discover, Phases 0-5 — see the section two below this one).
